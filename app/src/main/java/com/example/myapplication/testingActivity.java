...
//
//
//    TextView tv_LoginError, tv_eye_password, textView, textView6, textView7, textView17, textView31, textView24, textView26, textView33, textViewOrder;
//    EditText et_Username, et_Password, editTextPasswordInput;
...
//
//        tv_eye_password = findViewById(R.id.eyePassword);
...
//    }
//
//    public void accessScreen (View view){
...
//        if(!et_Username.getText().toString().equals("w") || !et_Password.getText().toString().equals("w")){
...
////
////                        panel.get(loggedUser.customerListStock.indexOf(stock)).setText(stock.symbol + " x " + stock.balance + " Price : " + stockQuote + " = " + stockQuoteTotal);
...
//        String textViewClickedText = textViewClicked.getText().toString();
//        stockSymbol = textViewClickedText.substring(0, textViewClickedText.indexOf(" "));
//
//        if(textViewClickedText.equals("")) return;
//
...
//
//        if(tv_eye_password.getText() == getApplicationContext().getResources().getString(R.string.icon_open_eye)){
//            tv_eye_password.setText( getApplicationContext().getResources().getString(R.string.icon_closed_eye));
...
//        }else{
//            tv_eye_password.setText( getApplicationContext().getResources().getString(R.string.icon_open_eye));
